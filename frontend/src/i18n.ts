...
const fr: Dict = {
  ...
  'watch.use': 'Utiliser ma position',
  'watch.locating': 'Localisation...',
  'watch.denied': 'Position refusée. La recherche de zone marche aussi.',
  'watch.unavailable': 'Géolocalisation indisponible sur cet appareil',
  'watch.here': 'Ma position',
  'watch.quiet': 'Rien ne concerne cette zone',
  'watch.notify': 'Activer les notifications',
  'watch.clear': 'Ne plus surveiller',
  'watch.privacy': 'Votre position ne quitte jamais votre appareil: tout est calculé dans cette page.',
...
const en: Dict = {
  ...
  'watch.use': 'Use my location',
  'watch.locating': 'Locating...',
  'watch.denied': 'Location refused. The area search works too.',
  'watch.unavailable': 'Geolocation unavailable on this device',
  'watch.here': 'My location',
  'watch.quiet': 'Nothing concerns this area',
  'watch.notify': 'Enable notifications',
  'watch.clear': 'Stop watching',
  'watch.privacy': 'Your location never leaves your device: everything is computed in this page.',
...
const es: Dict = {
  ...
  'watch.use': 'Usar mi ubicación',
  'watch.locating': 'Localizando...',
  'watch.denied': 'Ubicación denegada. La búsqueda de zona también sirve.',
  'watch.unavailable': 'Geolocalización no disponible',
  'watch.here': 'Mi ubicación',
  'watch.quiet': 'Nada afecta a esta zona',
  'watch.notify': 'Activar notificaciones',
  'watch.clear': 'Dejar de vigilar',
  'watch.privacy': 'Su ubicación nunca sale de su dispositivo: todo se calcula en esta página.',
...
const ja: Dict = {
  ...
  'watch.on': '監視中: {place}',
  'watch.use': '現在地を使う',
  'watch.locating': '位置を取得中...',
  'watch.denied': '位置情報が拒否されました。地域検索も使えます。',
  'watch.unavailable': 'この端末では位置情報を利用できません',
  'watch.here': '現在地',
  'watch.quiet': 'この地域に該当する事象はありません',
  'watch.notify': '通知を有効にする',
  'watch.clear': '監視を解除',
  'watch.privacy': '位置情報が端末から出ることはありません。すべてこのページ内で計算されます。',
  'filters.window': '期間',
...
const id: Dict = {
  ...
  'watch.use': 'Gunakan lokasi saya',
  'watch.locating': 'Mencari lokasi...',
  'watch.denied': 'Lokasi ditolak. Pencarian wilayah juga bisa.',
  'watch.unavailable': 'Geolokasi tidak tersedia di perangkat ini',
  'watch.here': 'Lokasi saya',
  'watch.quiet': 'Tidak ada yang menyangkut wilayah ini',
  'watch.notify': 'Aktifkan notifikasi',
  'watch.clear': 'Berhenti memantau',
  'watch.privacy': 'Lokasi Anda tidak pernah meninggalkan perangkat: semua dihitung di halaman ini.',
